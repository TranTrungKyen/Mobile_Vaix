<header class="bg-primary-custom pt-2 pb-2">
    <div class="container">
        <div class="row">
            <h1 class="col-2 mb-0">
                <a href="#" class="logo_img text-white d-flex flex-column">
            ...
            <div class="address_search d-flex col-6 algin-items-center">
                <div class="address d-flex flex-column">
                    <label for="address" class="mb-0 text-white font-size-12">Xem giá tại</label>
                    <select name="address" id="address" class="font-size-12">
                        <option value="1">Hà Nội</option>
                        <option value="2">Hồ Chí Minh</option>
                    </select>
                </div>
                <div class="search bg-white rounded overflow-hidden d-flex align-items-center ml-4 w-100 px-2">
                    <input type="text" name="search" class="search__input border-0 h-100 outline-none w-100" placeholder="Tìm kiếm tên sản phẩm">
                    <button class="border-0 bg-white">
                        <i class="fa-solid fa-magnifying-glass"></i>
                    </button>
                </div>
            </div>
            <div class="header-left-icons d-flex col-4 justify-content-between">
